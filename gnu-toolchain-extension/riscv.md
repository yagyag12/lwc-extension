...
;; ROTR32 (define_insn "riscv_rot" [(set(match_operand:SI 0 "register_operand" "=r,r") (unspec_volatile[(match_operand:SI 1 "register_operand" "r,r") (match_operand:SI 2 "arith_operand" "r,I")] UNSPECV_ROT))] "" "rot%i2\t%0,%1,%2" )

;; SBOX (define_insn "riscv_sbox" [(set(match_operand:SI 0 "register_operand" "=r,r") (unspec_volatile[(match_operand:SI 1 "register_operand" "r,r") (match_operand:SI 2 "arith_operand" "r,I")] UNSPECV_SBOX))] "" "sbox%i2\t%0,%1,%2" )
